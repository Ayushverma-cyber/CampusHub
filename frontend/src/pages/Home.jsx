...
function Home() {
  ...
  if (role === 'student') {
    ...
    const averageMarks =
      grades.length > 0
        ? (
            grades.reduce((sum, g) => sum + g.marks, 0) /
            grades.length
          ).toFixed(1)
        : 0
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8 text-white">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8 shadow-2xl">
          ...
          <p className="mt-3 text-indigo-100 text-lg">
            Stay on top of your academics and track your progress in
            real time.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="/dashboard" className="rounded-xl bg-slate-800 p-4 hover:bg-slate-700 transition-colors">
              Dashboard
            </a>

            <a href="/attendance" className="rounded-xl bg-slate-800 p-4 hover:bg-slate-700 transition-colors">
              Attendance
            </a>

            <a href="/grades" className="rounded-xl bg-slate-800 p-4 hover:bg-slate-700 transition-colors">
              Grades
            </a>

            <a href="/course" className="rounded-xl bg-slate-800 p-4 hover:bg-slate-700 transition-colors">
              Courses
            </a>
    ...
    <div className="max-w-7xl mx-auto p-6 text-white space-y-6">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-slate-900 to-slate-800 border border-slate-700 p-8 shadow-2xl">
        ...
        <p className="mt-3 text-slate-300 text-lg max-w-3xl">
          Manage students, attendance, grades, batches, and courses
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="/students" className="rounded-2xl border border-slate-800 bg-slate-900 p-6 hover:border-indigo-500/40 transition-colors">
        ...
        <a href="/attendance" className="rounded-2xl border border-slate-800 bg-slate-900 p-6 hover:border-emerald-500/40 transition-colors">
        ...
        <a href="/grades" className="rounded-2xl border border-slate-800 bg-slate-900 p-6 hover:border-amber-500/40 transition-colors">
        ...
        <a href="/course" className="rounded-2xl border border-slate-800 bg-slate-900 p-6 hover:border-purple-500/40 transition-colors">
